...
public class Graph<T> {
    ...
    public static void main(String args[]){
        ...
        graph.addVertex(new Vertex<Integer>("A",20));
        graph.addVertex(new Vertex<Integer>("B",1));
        graph.addVertex(new Vertex<Integer>("C",3));
        graph.addVertex(new Vertex<Integer>("D",50));
        graph.addVertex(new Vertex<Integer>("E",100));
        graph.addVertex(new Vertex<Integer>("F",200));
        graph.addVertex(new Vertex<Integer>("G",5));
        Vertex<Integer> root = graph.getVerticies().get(0);
        graph.setRootVertex(root);
        graph.addEdge(graph.getVerticies().get(0),graph.getVerticies().get(1),1);
        graph.addEdge(graph.getVerticies().get(1),graph.getVerticies().get(2),1);
        graph.addEdge(graph.getVerticies().get(2),graph.getVerticies().get(3),1);
        graph.addEdge(graph.getVerticies().get(3),graph.getVerticies().get(5),1);
        graph.addEdge(graph.getVerticies().get(2),graph.getVerticies().get(4),1);
        graph.addEdge(graph.getVerticies().get(4),graph.getVerticies().get(5),1);
        graph.addEdge(graph.getVerticies().get(5),graph.getVerticies().get(6),1);
        for(int i =0 ;i<graph.getVerticies().size();i++){
            System.out.println(graph.getVerticies().get(i));
        }
        VisitorEX<Integer, Exception> visitor=null;
        try {
            graph.depthFirstSearch(graph.getRootVertex(),visitor);
        } catch (Exception e) {
            e.printStackTrace();
        }
        ...
        try {
            graph.breadthFirstSearch(graph.getRootVertex(),visitor);
        } catch (Exception e) {
            e.printStackTrace();
        }

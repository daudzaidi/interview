package TusharRoyVideos.Graph;

import TusharRoyVideos.Graph.Heap.BinaryMinHeap;


import java.util.*;

/**
 * Created by shalvi on 06/10/16.
 * This algo helps us find minimum spanning tree
 * ALGO
 * 1.need a binary min heap
 * 2.need a map storing vertex and edge
 * 3.Fill heap with vertices(distance ) - initial infinite
 * 4.make source vertex distance = 0 in heap
 * 5.Extract min element
 * 6.Explore neighbours
 * 7.Update min heap with min distance and update map with neighbours and their edges
 *
 */
public class PrimAlgorithm {
    ...
    public static void main(String args[]){
     ...
     /* graph.addEdge(0, 1, 4);
        ...
        System.out.println("SUM of Min Spanning Tree Edges = "+sum);
    }
}
